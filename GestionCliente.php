					...
					<div class="nav">
						...
						<div class="collapse" id="collapsePages" aria-labelledby="headingTwo" data-parent="#sidenavAccordion">
							<nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
								<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#pagesCollapseAuth" aria-expanded="false" aria-controls="pagesCollapseAuth">Area cliente
									<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div></a>
									<div class="collapse" id="pagesCollapseAuth" aria-labelledby="headingOne" data-parent="#sidenavAccordionPages">
										<nav class="sb-sidenav-menu-nested nav"><a class="nav-link" href="GestionCliente.php">Registro de clientes</a><a class="nav-link" href="ConsultarClientes.php">Consulta de clientes</a></nav>
									</div>
										...
										<div class="col-lg-12">
											...
											<form action="insertaclientes.php" method="POST">
												...
												<div class="modal-footer">
													<button type="submit" name="insertacliente" class="btn btn-success"><i
